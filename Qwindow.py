...
class CET_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        mainWindow.resize(493, 134)
        mainWindow.setFixedSize(493,134)
        mainWindow.setGeometry(QtCore.QRect(20, 50, 200, 200))
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "Color extraction tool"))
